...
namespace CyberErp.Data.Model
{
    ...
    public partial class iffsJobOrderHistoryHeader
    {
        public iffsJobOrderHistoryHeader()
        {
            this.iffsJobOrderHistoryDetail = new HashSet<iffsJobOrderHistoryDetail>();
        }
        ...
        public virtual ICollection<iffsJobOrderHistoryDetail> iffsJobOrderHistoryDetail { get; set; }
